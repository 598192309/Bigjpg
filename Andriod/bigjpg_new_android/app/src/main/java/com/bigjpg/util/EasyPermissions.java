...
public class EasyPermissions {
    ...
    public static void requestPermissions(final Object object, String rationale,
        ...
        if (shouldShowRationale) {
            ...
            DialogUtil.showTwoButtonTipDialog(activity, "", rationale, ResourcesUtil.getString(activity, negativeButton), ResourcesUtil.getString(activity, positiveButton),
    ...
    public static boolean checkDeniedPermissionsNeverAskAgain(final Object object,
                                                              ...
                                                              @StringRes int positiveButton,
                                                              @StringRes int negativeButton,
                                                              @Nullable View.OnClickListener negativeButtonOnClickListener,
                                                              List<String> deniedPerms) {
